...
namespace Steamworks
{
    ...
    public struct SteamUGCDetails_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bBanned; // whether the file was banned
    ...
    public struct CallbackMsg_t
    {
        ...
        public int
            m_iCallback; // Callback identifier.  (Corresponds to the k_iCallback enum in the callback structure.)
    ...
    public struct SteamDatagramGameCoordinatorServerLogin
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray,
            SizeConst = Constants.k_cbMaxSteamDatagramGameCoordinatorServerLoginAppData)]
    ...
    public struct SteamNetConnectionInfo_t
    {
        ...
        public string m_szEndDebug
        {
            ...
            set => InteropHelp.StringToByteArrayUTF8(value, m_szEndDebug_,
                Constants.k_cchSteamNetworkingMaxConnectionCloseReason);
        }
        ...
        public string m_szConnectionDescription
        {
            ...
            set => InteropHelp.StringToByteArrayUTF8(value, m_szConnectionDescription_,
                Constants.k_cchSteamNetworkingMaxConnectionDescription);
        }

...
namespace Steamworks
{
    public static class SteamScreenshots
    {
	    ...
	    public static ScreenshotHandle WriteScreenshot(byte[] pubRGB, uint cubRGB, int nWidth, int nHeight)
        {
            ...
            return (ScreenshotHandle)NativeMethods.ISteamScreenshots_WriteScreenshot(
                CSteamAPIContext.GetSteamScreenshots(), pubRGB, cubRGB, nWidth, nHeight);
        }
	    ...
	    /// </summary>
	    public static ScreenshotHandle AddScreenshotToLibrary(string pchFilename, string pchThumbnailFilename,
            int nWidth, int nHeight)
        {
            ...
            {
                return (ScreenshotHandle)NativeMethods.ISteamScreenshots_AddScreenshotToLibrary(
                    CSteamAPIContext.GetSteamScreenshots(), pchFilename2, pchThumbnailFilename2, nWidth, nHeight);
            }
        }

	    /// <summary>
	    ///     <para>
	    ///         Causes the Steam overlay to take a screenshot.  If screenshots are being hooked by the game then a
	    ///         ScreenshotRequested_t callback is sent back to the game instead.
	    ///     </para>
	    /// </summary>
	    ...
	    /// <summary>
	    ///     <para>
	    ///         Toggles whether the overlay handles screenshots when the user presses the screenshot hotkey, or the game
	    ///         handles them.  If the game is hooking screenshots,
	    ///     </para>
	    ///     <para>
	    ///         then the ScreenshotRequested_t callback will be sent if the user presses the hotkey, and the game is
	    ///         expected to call WriteScreenshot or AddScreenshotToLibrary
	    ///     </para>
	    ...
	    public static bool SetLocation(ScreenshotHandle hScreenshot, string pchLocation)
        {
            ...
            {
                return NativeMethods.ISteamScreenshots_SetLocation(CSteamAPIContext.GetSteamScreenshots(), hScreenshot,
                    pchLocation2);
            }
        }
        ...
        {
            InteropHelp.TestIfAvailableClient();
            return NativeMethods.ISteamScreenshots_TagUser(CSteamAPIContext.GetSteamScreenshots(), hScreenshot,
                steamID);
        }
        ...
        {
            InteropHelp.TestIfAvailableClient();
            return NativeMethods.ISteamScreenshots_TagPublishedFile(CSteamAPIContext.GetSteamScreenshots(), hScreenshot,
                unPublishedFileID);
        }
	    ...
	    ///     <para> JPEG, TGA, and PNG formats are supported.</para>
	    /// </summary>
	    public static ScreenshotHandle AddVRScreenshotToLibrary(EVRScreenshotType eType, string pchFilename,
            string pchVRFilename)
        {
            ...
            {
                return (ScreenshotHandle)NativeMethods.ISteamScreenshots_AddVRScreenshotToLibrary(
                    CSteamAPIContext.GetSteamScreenshots(), eType, pchFilename2, pchVRFilename2);
            }
        }
    }
}

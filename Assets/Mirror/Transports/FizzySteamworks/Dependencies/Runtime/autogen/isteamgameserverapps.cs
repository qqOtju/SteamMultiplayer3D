    ...
    public static class SteamGameServerApps
    {
        ...
        public static string GetCurrentGameLanguage()
        {
            ...
            return InteropHelp.PtrToStringUTF8(
                NativeMethods.ISteamApps_GetCurrentGameLanguage(CSteamGameServerAPIContext.GetSteamApps()));
        }
        ...
        public static string GetAvailableGameLanguages()
        {
            InteropHelp.TestIfAvailableGameServer();
            return InteropHelp.PtrToStringUTF8(
                NativeMethods.ISteamApps_GetAvailableGameLanguages(CSteamGameServerAPIContext.GetSteamApps()));
        }
        ...
        {
            InteropHelp.TestIfAvailableGameServer();
            return NativeMethods.ISteamApps_GetEarliestPurchaseUnixTime(CSteamGameServerAPIContext.GetSteamApps(),
                nAppID);
        }
            ...
            int cchNameBufferSize)
        {
            ...
            var ret = NativeMethods.ISteamApps_BGetDLCDataByIndex(CSteamGameServerAPIContext.GetSteamApps(), iDLC,
                out pAppID, out pbAvailable, pchName2, cchNameBufferSize);
        ...
        public static bool GetCurrentBetaName(out string pchName, int cchNameBufferSize)
        {
            InteropHelp.TestIfAvailableGameServer();
            var pchName2 = Marshal.AllocHGlobal(cchNameBufferSize);
            var ret = NativeMethods.ISteamApps_GetCurrentBetaName(CSteamGameServerAPIContext.GetSteamApps(), pchName2,
                cchNameBufferSize);
            pchName = ret ? InteropHelp.PtrToStringUTF8(pchName2) : null;
            Marshal.FreeHGlobal(pchName2);
            return ret;
        ...
        {
            InteropHelp.TestIfAvailableGameServer();
            return NativeMethods.ISteamApps_MarkContentCorrupt(CSteamGameServerAPIContext.GetSteamApps(),
                bMissingFilesOnly);
        }
        ...
        {
            InteropHelp.TestIfAvailableGameServer();
            return NativeMethods.ISteamApps_GetInstalledDepots(CSteamGameServerAPIContext.GetSteamApps(), appID,
                pvecDepots, cMaxDepots);
        }
        ...
        public static uint GetAppInstallDir(AppId_t appID, out string pchFolder, uint cchFolderBufferSize)
        {
            ...
            var ret = NativeMethods.ISteamApps_GetAppInstallDir(CSteamGameServerAPIContext.GetSteamApps(), appID,
                pchFolder2, cchFolderBufferSize);
        ...
        public static string GetLaunchQueryParam(string pchKey)
        {
            ...
            {
                return InteropHelp.PtrToStringUTF8(
                    NativeMethods.ISteamApps_GetLaunchQueryParam(CSteamGameServerAPIContext.GetSteamApps(), pchKey2));
            }
        }
        ...
        {
            InteropHelp.TestIfAvailableGameServer();
            return NativeMethods.ISteamApps_GetDlcDownloadProgress(CSteamGameServerAPIContext.GetSteamApps(), nAppID,
        ...
        public static SteamAPICall_t GetFileDetails(string pszFileName)
        {
            ...
            {
                return (SteamAPICall_t)NativeMethods.ISteamApps_GetFileDetails(
                    CSteamGameServerAPIContext.GetSteamApps(), pszFileName2);
            }
        }
        ...
        public static int GetLaunchCommandLine(out string pszCommandLine, int cubCommandLine)
        {
            ...
            var ret = NativeMethods.ISteamApps_GetLaunchCommandLine(CSteamGameServerAPIContext.GetSteamApps(),
        ...
        {
            InteropHelp.TestIfAvailableGameServer();
            return NativeMethods.ISteamApps_BIsTimedTrial(CSteamGameServerAPIContext.GetSteamApps(),

...
namespace Steamworks
{
    ...
    public struct GameConnectedChatLeave_t
    {
        ...
        public CSteamID m_steamIDClanChat;
        public CSteamID m_steamIDUser;
        [MarshalAs(UnmanagedType.I1)] public bool m_bKicked; // true if admin kicked
        [MarshalAs(UnmanagedType.I1)] public bool m_bDropped; // true if Steam connection dropped
    }
    ...
    public struct SetPersonaNameResponse_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bSuccess; // true if name change succeeded completely.
    ...
    public struct OverlayBrowserProtocolNavigation_t
    {
        ...
        {
            get => InteropHelp.ByteArrayToStringUTF8(rgchURI_);
    ...
    public struct GSReputation_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bBanned; // True if the server is banned from the Steam
        // master servers
    ...
    public struct FavoritesListChanged_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bAdd; // true if this is adding the entry, otherwise it is a remove
    ...
    public struct LobbyEnter_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bLocked; // If true, then only invited users may join
    ...
    public struct SearchForGameResultCallback_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bFinalCallback;
    }
    ...
    public struct MusicPlayerWantsShuffled_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bShuffled;
    }
    ...
    public struct RemoteStorageAppSyncProgress_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bUploading; // if false, downloading
    }
    ...
    public struct RemoteStorageGetPublishedFileDetailsResult_t
    {
        ...
        public string m_rgchDescription // description of document
        {
            ...
            set => InteropHelp.StringToByteArrayUTF8(value, m_rgchDescription_,
                Constants.k_cchPublishedDocumentDescriptionMax);
        }
    ...
    public struct SteamUGCQueryCompleted_t
    {
        ...
        public string
            m_rgchNextCursor // If a paging cursor was used, then this will be the next cursor to get the next result set.
        {
    ...
    public struct MarketEligibilityResponse_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bAllowed;
        public EMarketNotAllowedReasonFlags m_eNotAllowedReason;
        public RTime32 m_rtAllowedAtTime;

        public int
            m_cdaySteamGuardRequiredDays; // The number of days any user is required to have had Steam Guard before they can use the market

        public int
            m_cdayNewDeviceCooldown; // The number of days after initial device authorization a user must wait before using the market on that device
    }
    ...
    public struct UserStatsReceived_t
    {
        ...
        [FieldOffset(0)] public ulong m_nGameID; // Game these stats are for
        [FieldOffset(8)] public EResult m_eResult; // Success / error fetching the stats
        [FieldOffset(12)] public CSteamID m_steamIDUser; // The user for whom the stats are retrieved for
    }
    ...
    public struct UserAchievementStored_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bGroupAchievement; // if this is a "group" achievement
    ...
    public struct LeaderboardScoreUploaded_t
    {
        ...
        public int
            m_nGlobalRankPrevious; // the previous global rank of the user in this leaderboard; 0 if the user had no existing entry in the leaderboard
    }
    ...
    public struct UserAchievementIconFetched_t
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bAchieved; // Is the icon for the achieved or not achieved version?

        public int
            m_nIconHandle; // Handle to the image, which can be used in SteamUtils()->GetImageRGBA(), 0 means no image is set for the achievement
    }

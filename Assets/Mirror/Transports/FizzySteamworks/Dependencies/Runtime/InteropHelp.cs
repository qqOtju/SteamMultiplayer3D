...
namespace Steamworks
{
    ...
    public class DllCheck
    {
	    ...
	    /// <summary>
	    ///     This is an optional runtime check to ensure that the dlls are the correct version. Returns false only if the
	    ///     steam_api.dll is found and it's the wrong size or version number.
	    /// </summary>

...
namespace Steamworks
{
    ...
    public struct CSteamID : IEquatable<CSteamID>, IComparable<CSteamID>
    {
        ...
        {
            m_SteamID = (m_SteamID & ~(0xFFFFFFFFul << 0)) | (((ulong)other & 0xFFFFFFFFul) << 0);
        }

        public void SetAccountInstance(uint other)
        {
            m_SteamID = (m_SteamID & ~(0xFFFFFul << 32)) | ((other & 0xFFFFFul) << 32);
        }

        // This is a non standard/custom function not found in C++ Steamworks
        public void SetEAccountType(EAccountType other)
        {
            m_SteamID = (m_SteamID & ~(0xFul << 52)) | (((ulong)other & 0xFul) << 52);
        }

        public void SetEUniverse(EUniverse other)
        {
            m_SteamID = (m_SteamID & ~(0xFFul << 56)) | (((ulong)other & 0xFFul) << 56);
        }
